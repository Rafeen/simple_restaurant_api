...
use crate::models::order::{
    insert_order_item,
    fetch_order_item_by_item,
    fetch_all_order_item_for_table,
    update_order_item,
    delete_order_item_for_table,
    delete_all_orders_for_table,
    fetch_remaining_order_item_for_table,
    is_duplicate_order,
    OrderItem,
    NewOrderItem,
};
use crate::utils::api::api_response::{ApiResponse, to_bad_request_response, to_resource_not_found_response};
use rocket::{get, post, delete, put};
...
#[get("/<table_id>")]
pub async fn get_all_order_for_table(db: &rocket::State<sqlx::PgPool>, table_id: i32) -> ApiResponse {
...
pub async fn get_order_for_table_by_item(db: &rocket::State<sqlx::PgPool>, table_id: i32, item_id: i32) -> ApiResponse {
...
pub async fn get_remaining_order_for_table(db: &rocket::State<sqlx::PgPool>, table_id: i32) -> ApiResponse {
...
pub async fn create_order(db: &rocket::State<sqlx::PgPool>, table_id: i32, order_items: Json<Vec<NewOrderItem>>) -> ApiResponse {
    let is_duplicate = is_duplicate_order(db, table_id, &order_items).await;
    return match is_duplicate {
        true => { to_bad_request_response(format!("order for these items for table {} already exists", table_id)) }
        false => {
...
#[delete("/<table_id>")]
pub async fn remove_all_order_for_table(db: &rocket::State<sqlx::PgPool>, table_id: i32) -> ApiResponse {
...
pub async fn remove_order_item(db: &rocket::State<sqlx::PgPool>, table_id: i32, item_id: i32) -> ApiResponse {
...
pub async fn update_order(db: &rocket::State<sqlx::PgPool>, table_id: i32, order_item: Json<OrderItem>) -> ApiResponse {
